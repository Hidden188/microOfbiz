...
public class MusicPlayer extends JFrame {
	// 显示(歌曲名称)播放状态的标签
	JLabel songNameLabel = null; // 四个播放功能键按钮
	...
	final String DIR = "songs\\"; // 播放音乐的线程
	...
	public MusicPlayer() {
		...
		// 歌曲列表
		/*
		 * songsList = new JList(); songsList.setBounds(10, 150, 250, 300);
		 * songsList.setBackground(Color.CYAN); //把所有歌曲名逐个添加到List中
		 * //songsList.setListData(strSongNames); for(int
		 * i=0;i<strSongNames.length;i++){ DefaultListModel dm =
		 * (DefaultListModel)songsList.getModel(); dm.add(i,strSongNames[i]); }
